...
class Pengaturan extends BaseController
{
	...
	public function index()
	{
		...
		return view('pengaturan/views', $data);
	}
	...
	public function ubah_foto_profil()
	{
		...
		$path_thumb = base_url() . '/assets/img/user/thumbnail/';
		$get_file_thumb = $path_thumb . $data_lama['foto'];
		if (file_exists($get_file_thumb)) {
			unlink($get_file_thumb);
		}

		$path = base_url() . '/assets/img/user/';
		$get_file = $path . $data_lama['foto'];
