...
use \App\Models\JenisPeriodikModel;
use \App\Models\MesinModel;
use \App\Models\OverhaulModel;
use \App\Models\ULPLModel;
use \App\Models\PLTDModel;
...
class Manager extends BaseController
{
	public function __construct()
	{
		...
		$this->JenisPeriodikModel = new JenisPeriodikModel();
		$this->MesinModel = new MesinModel();
		$this->OverhaulModel = new OverhaulModel();
		$this->ULPLModel = new ULPLModel();
		$this->PLTDModel = new PLTDModel();
	...
	public function index()
	{
		$data = [
			...
			'data_manager' => $this->UserModel->getUserAktifByLevel(3)
		];

		return view('data-master/manager/views', $data);
	}
