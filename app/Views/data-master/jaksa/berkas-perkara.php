				...
				<div class="card-header">
					<div class="d-flex align-items-center justify-content-between">
						<h3 class="card-title font-weight-bold">
							Data Berkas Perkara <span class="text-primary"><i>(Jaksa - <?= $jaksa_select['nama_lengkap']; ?>)</i></span>
						</h3>

						<div>
							<a href="<?= base_url(); ?>/data-master/jaksa" class="btn btn-dark text-white">
						...
						<table class="table table-sm table-hover table-responsive-sm table-striped" id="data-table-custom" style="font-size: 10px;">
							...
							<tbody>
								...
								$data_berkas_perkara = $db->query(
									"SELECT * FROM berkas_perkara WHERE FIND_IN_SET('$id_jaksa_select', jaksa_terkait) ORDER BY tanggal_penerimaan DESC"
								)->getResult("array");
								?>
