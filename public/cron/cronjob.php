<?php if (isset($_GET['code']) and $_GET['code'] == "gyYaOg9me10TQH9ZJXRGMXi132mjX34bDWiGQUme0KTmzRc4YPAETOJ7Cq58YOHugxVyuWcqElE4Uz8QMGTLXvL9ot9N8Ac81xCQ") : ?>
	<script src="https://cdnjs.cloudflare.com/ajax/libs/jquery/3.6.2/jquery.min.js" integrity="sha512-tWHlutFnuG0C6nQRlpvrEhE4QpkG1nn2MOUMWmUeRePl4e3Aki0VB6W1v3oLjFtd0hVOtRQ9PHpSfN6u6/QXkQ==" crossorigin="anonymous" referrerpolicy="no-referrer"></script>

	<div id="loader">Mencoba Mengirim ...</div>
	<div id="status"></div>
	<div id="loadData"></div>


	<script>
		const base_url = 'https://kejariberau.id/';
		...
		// Pak ITO
		kirim_whatsapp('1fb92afe72a55161160bdd2c642055cf', '085245567747', 'Hallo test', '');
